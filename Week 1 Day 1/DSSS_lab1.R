...
correct <- TRUE # Or: T, always capitalized
wrong <- FALSE # Or: F, always capitalized
...
# easier to type: prof_qual, sex, year, num
# names if you'd like.
...
# or an easier way with lappy and pivot_wider
library(tidyverse)
...
fe_prop3 <- pivot_wider(higher_edu, ****)
fe_prop3$prop <- *****

# Bonus: Plot the trend of the proportion you calculated with ggplot
ggplot(fe_prop, *******)
